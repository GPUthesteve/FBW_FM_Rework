...
#ifndef FLYBYWIRE_AIRCRAFT_TABLES1502_A32XCEO_HPP
#define FLYBYWIRE_AIRCRAFT_TABLES1502_A32XCEO_HPP
...
class Tables1502_A32X {
 ...
 public:
  ...
  static double iCN2(double pressureAltitude, double mach) {
    ...
    return 60 / ((std::sqrt)((288.15 - (1.98 * pressureAltitude / 1000)) / 288.15) * (std::sqrt)(1 + (0.2 * (std::pow)(mach, 2))));
  }
